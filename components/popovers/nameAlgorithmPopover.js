...
class NameAlgorithmPopover {
    constructor (screen, backButton, searchBar, playlistId) {
        ...
        toolbarKeypress(this.nameBox, () => {}, () => {}, () => {}, focusFunction(this.closeBox), focusFunction(this.saveBox))
        toolbarKeypress(this.closeBox, () => {}, focusFunction(this.nextBox), () => {
        ...
        toolbarKeypress(this.nextBox, focusFunction(this.closeBox), () => {}, () => {
            focusText(this.nameBox)
        }, () => {}, () => {
            this.nameAlgBox.destroy()
            new BuildAlgorithmPopover(this.nameBox.value, this.screen, backButton, searchBar, playlistId)
        })
        focusText(this.nameBox)
