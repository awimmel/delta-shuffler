...
module.exports = function createPlaylistToolbar(parent, searchBar, algorithmsTable, songsTable) {
    ...
    toolbarKeypress(createAlgorithm, focusFunction(backButton), focusFunction(showAlgorithms), () => {
    ...
    toolbarKeypress(showAlgorithms, focusFunction(createAlgorithm), focusFunction(showSongs), () => {
        focusText(localSearchBar)
    }, () => {
        focusTable()
    }, () => {
    ...
    toolbarKeypress(showSongs, focusFunction(showAlgorithms), () => {}, () => {
        focusText(localSearchBar)
    }, () => {
        focusTable()
    }, () => {
        searchBar.setValue('')
        localSongsTable.setData([['SONG', 'ARTIST', 'ALBUM'], ...songHelper.displaySongs(localSongsTable.rawData)])
