...
module.exports = function createPlaylistDetailsView(parent, searchBar) {
    ...
    const playlistToolbar = createPlaylistToolbar(playlistDetailsView, searchBar, algorithmsTable, songsTable)
    ...
    setTableKeypress(algorithmsTable, (index) => {
        const algorithm = {
    ...
    setTableKeypress(songsTable, (index) => {
        const song = {
